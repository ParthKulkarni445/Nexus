              ...
              <div className="flex items-center gap-2">
                {showModerationPanel && canViewModeration && (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-md border border-slate-300 bg-slate-100 px-2.5 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-200 transition-colors"
                  >
                    <ShieldCheck size={14} />
                    Queue
                    {moderationQueue.length > 0 && (
                      <span className="ml-0.5 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-slate-300 px-1 text-[10px] font-bold text-slate-900">
                ...
                {allowCreate && (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-md bg-[#2563EB] px-2.5 py-1.5 text-xs font-semibold text-white hover:bg-slate-800"
                  >
                    <BookOpen size={14} />
                    Create
                  </button>
