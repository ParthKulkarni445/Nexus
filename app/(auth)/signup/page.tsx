...
import { OrbitIcon, Eye, EyeOff, Loader2, AlertCircle, Mail } from "lucide-react";
...
const strengthMeta: Record<0 | 1 | 2 | 3 | 4, { label: string; color: string }> = {
      ...
      <div className="relative space-y-8">
        <div>
          <h2 className="text-[1.85rem] font-bold text-white leading-snug">
            Join the Nexus<br />TPO Platform
          </h2>
          <p className="mt-3 text-white/60 text-sm leading-relaxed max-w-xs">
            Create your account and get access to placement drives, company listings, and all TPO resources in one place.
          </p>
        </div>
          ...
          {step === "form" ? (
            <>
              ...
              <form onSubmit={handleRequestOtp} className="space-y-4">
                      ...
                      <div className="flex gap-1">
                        {[1, 2, 3, 4].map((i) => (
                          <div
                            ...
                            style={{ background: strength >= i ? meta.color : "#E2E8F0" }}
                          />
                        ))}
                      </div>
                      {meta.label && (
                ...
                {/* Confirm password */}
                <div>
                  <label htmlFor="confirm" className="block text-sm font-medium text-[#0F172A] mb-1.5">
                    Confirm password
                  </label>
                  <div className="relative">
                    <input
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-5">
              ...
              <button
                type="button"
                onClick={() => { setStep("form"); setApiError(null); setOtp(""); }}
